...
class AdminDonHang
{
    ...
    public function updateDonHang($id,$ten_nguoi_nhan,$sđt_nguoi_nhan,$email_nguoi_nhan,$dia_chi_nguoi_nhan,$ghi_chu,$trang_thai_id) {
        try {
            // var_dump($id);die;
            $sql = 'UPDATE don_hangs
                    SET
                        ten_nguoi_nhan = :ten_nguoi_nhan,
                        sđt_nguoi_nhan = :sđt_nguoi_nhan,
            ...
            $stmt = $this->conn->prepare($sql);// var_dump($stmt);die;
            $stmt->execute([
                ':ten_nguoi_nhan' => $ten_nguoi_nhan,
                ':sđt_nguoi_nhan' => $sđt_nguoi_nhan,
                ':email_nguoi_nhan' => $email_nguoi_nhan,
